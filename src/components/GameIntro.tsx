...
export const GameIntro = ({
  ...
  return <div className="min-h-screen flex items-center justify-center bg-gradient-hero animate-fade-in overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Floating emojis */}
        <div className="absolute top-10 left-1/4 text-4xl opacity-20 animate-float" style={{animationDelay: '0s'}}>🚀</div>
        <div className="absolute top-1/3 right-1/4 text-4xl opacity-20 animate-float" style={{animationDelay: '1s'}}>🤖</div>
        <div className="absolute bottom-20 left-1/3 text-4xl opacity-20 animate-float" style={{animationDelay: '2s'}}>🧬</div>
        <div className="absolute top-1/4 right-10 text-4xl opacity-20 animate-float" style={{animationDelay: '1.5s'}}>⚡</div>
        <div className="absolute bottom-1/4 right-1/3 text-4xl opacity-20 animate-float" style={{animationDelay: '2.5s'}}>🌟</div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <h2 className="text-5xl font-bold mb-6 text-primary drop-shadow-[0_0_30px_rgba(255,138,0,0.7)] animate-glow-pulse">
          INDIA 2035 🇮🇳
        </h2>
        ...
        <Button 
          onClick={onStart} 
          size="lg" 
          className="text-xl px-12 py-6 bg-primary hover:bg-primary-glow shadow-intense transition-all duration-300 hover:scale-110 animate-bounce-slow hover:shadow-[0_0_100px_rgba(255,138,0,0.9)]"
        >
          🚀 Start Your Journey
        </Button>
